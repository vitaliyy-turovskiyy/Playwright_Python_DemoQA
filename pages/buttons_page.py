...
class Buttons:
    ...
    def __init__(self, page: Page):
        ...
        self.__dynamic_btn = self.page.locator('button[id="wXjOf"]')
    ...
    def check_rmb_click_result(self) -> None:
        ...
        assert self.__right_click_msg.text_content() == 'You have done a right click', \
          f'Expected a double click massage, got {self.__right_click_msg.text_content()} instead'

    def click_the_button(self) -> None:
        self.__dynamic_click_msg.click()
    ...
    def check_click_result(self) -> None:
        ...
        assert self.__dynamic_click_msg.text_content() == 'You have done a dynamic click', \
          f'Expected a double click massage, got {self.__dynamic_click_msg.text_content()} instead'